...
<header class="h-screen w-full">
	<div class="w-full mx-auto md:w-2/5 h-full flex flex-col items-start justify-between lg:ml-auto lg:mr-0 pb-4">
		<div class="flex flex-col justify-between h-3/5 w-full gap-2">
			...
			<div class="px-4 rounded-full hover:bg-gray-200 w-fit py-2 flex items-center">
				<a class="text-2xl text-black no-underline hover:no-underline flex" href="notifications"><i
					...
					<span class="hidden xl:block ">Nofications</span></a>
			</div>
			<div class="px-4 rounded-full hover:bg-gray-200 w-fit py-2 flex items-center">
